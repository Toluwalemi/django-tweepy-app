...
class Tip(models.Model):
    ...
    """
    tweep = models.ForeignKey(User, on_delete=models.CASCADE, related_name='tips')
    python_tip = models.CharField(max_length=280)
    link = models.ForeignKey(Link, on_delete=models.CASCADE,
                             related_name='tips_link')  # e.g logging = Tip.objects.get(name='logging') ->
    # logging.tips_link.all()
